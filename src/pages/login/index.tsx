        ...
        <div className="h-screen flex">
          ...
          <div className="flex w-1/2 justify-center items-center bg-white">
            <form
              ...
              <button
                className="mt-6 block w-full select-none rounded-lg bg-gradient-to-tr from-blue-800 to-purple-700 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md transition-all active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                type="submit"
