...
export const FooterList = () => {
  return "text-gray-700 hover:underline dark:text-gray-400 font-thin";
};
        ...
        <footer className="p-4 bg-[#d6d7d6] rounded-xl sm:p-16 sm:pb-10 dark:bg-gray-800">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-600 w-[150px] mt-3 font-thin text-sm">
                A place where nature and adventure unite
              </p>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h3 className="mb-6 text-base text-gray-900 dark:text-white">
                  About Us
                </h3>
                <ul>
                  <li className="mb-4">
                    <a href="#" target="_blank" className={FooterList()}>
                      Our guides
                    </a>
                  </li>
                  <li className="mb-4">
